...
export const Banner = () => {
  return (
    <section className="relative px-6 ux:px-6 sm:px-20 sm:pt-0 pb-10 sm:pb-0 bg-indigo-50 dark:bg-gray-800 flex flex-col">
      <div className="h-[70px] bg-indigo-50 dark:bg-gray-800"></div>
      ...
      <div className="w-full max-w-7xl mx-auto flex justify-between items-center flex-col sm:flex-row-reverse gap-8 sm:gap-1">
        ...
        <main className="p-3 w-full flex flex-col sm:justify-between gap-2">
          <div className="flex items-center lg:ml-[-20px] gap-3 sm:gap-6">
            <article className="py-2 w-fit text-indigo-600 dark:text-indigo-200 flex items-center min-w-20 ux:min-w-[100px] lg:min-w-52">
              <Logo className="fill-current text-indigo-600 dark:text-indigo-200" />
            </article>
            <h1 className="text-md ux:text-xl font-semibold lg:text-3xl uppercase text-indigo-600 dark:text-indigo-200 ux:space-y-1 lg:space-y-4">
          ...
          <p className="text-zinc-600 dark:text-gray-200 max-w-[60ch]">
          ...
          <PrimaryButton className="mt-6 self-center ux:self-start">
            <span className="hidden md:inline-block mr-1">Просмотреть</span> Все Курсы{' '}
            <span className="ml-2 mt-1 transition-colors duration-200">→</span>
          </PrimaryButton>
        </main>
      </div>
    </section>
